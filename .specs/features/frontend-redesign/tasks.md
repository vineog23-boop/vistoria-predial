...
- [ ] **Step 1: Obter a confirmação operacional da migration**
...
- [ ] **Step 2: Escrever o teste de integração RED**
...
- [ ] **Step 3: Executar RED com Docker ativo**
...
- [ ] **Step 4: Tornar a geração de IDs portável sem nova migration**
...
- [ ] **Step 5: Executar PostgreSQL e suíte completa**
...
- [ ] Confirmação sobre histórico persistente está registrada.
- [ ] Flyway aplica V1-V3 em PostgreSQL 16 vazio.
- [ ] Hibernate/Flyway e a suíte completa permanecem verdes.
- [ ] T2 está marcado antes do commit.
